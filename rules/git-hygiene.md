...
- Propose cleaning up branches/worktrees right after a merge lands — zombies left to accumulate cost far more to untangle later. (For worktree removal see the `worktree-cleanup` skill; for integrating a finished branch see the `superpowers:finishing-a-development-branch` skill.)
